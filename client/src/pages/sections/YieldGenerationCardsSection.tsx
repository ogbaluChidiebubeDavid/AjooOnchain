        ...
        <div className="flex flex-col gap-6 p-[50px] pt-[35px]">
          ...
          <div className="flex bg-[#523f2033] rounded-3xl overflow-hidden border-[0.2px] border-solid border-[#f6bd60] p-6">
            <div className="flex flex-col gap-1">
              ...
              <span className="[font-family:'Syne',Helvetica] font-normal text-surface-50 text-[32px] tracking-[0] leading-[48px] whitespace-nowrap">
                9.47%
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="font-body-md font-[number:var(--body-md-font-weight)] text-primary-100 text-[length:var(--body-md-font-size)] tracking-[var(--body-md-letter-spacing)] leading-[var(--body-md-line-height)] whitespace-nowrap [font-style:var(--body-md-font-style)]">
                Low Risk
              </span>
            </Button>
            ...
            >
              <span className="font-body-md font-[number:var(--body-md-font-weight)] text-secondary-100 text-[length:var(--body-md-font-size)] tracking-[var(--body-md-letter-spacing)] leading-[var(--body-md-line-height)] whitespace-nowrap [font-style:var(--body-md-font-style)]">
