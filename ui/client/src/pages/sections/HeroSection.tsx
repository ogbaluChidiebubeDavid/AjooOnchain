    ...
    try {
      ...
      if (provider instanceof ethers.BrowserProvider) {
        ...
        try {
          ...
          const cycleDuration = await contract.cycleDuration();
          console.log("Cycle Duration from contract:", cycleDuration.toString());
        } catch (contractError) {
        ...
        toast({
          ...
          description: "Please install Core or MetaMask to connect.",
          variant: "destructive",
        });
      }
    } catch (error: any) {
      ...
      <header className="w-full bg-[#202327] relative z-20">
        <div className="max-w-[1440px] mx-auto flex items-center justify-between h-[84px] px-6 md:px-12 lg:px-20">
          ...
          <button
            ...
            className="hidden lg:inline-flex items-center justify-center gap-2 px-5 py-2 bg-[#0f766e] rounded-3xl hover:bg-[#0f766e]/90 transition-colors"
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-[#202327] border-t border-white/10 px-6 pb-6">
            <nav className="flex flex-col gap-4 pt-4">
              ...
              <button
                onClick={connectWallet}
                className="inline-flex items-center justify-center gap-2 px-5 py-2 bg-[#0f766e] rounded-3xl mt-2 w-fit"
      ...
      <div className="relative overflow-hidden bg-black">
        ...
        <div ref={heroContent.ref} className={`reveal ${heroContent.isVisible ? "visible" : ""} relative max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between px-6 md:px-12 lg:px-20 pt-16 md:pt-24 lg:pt-[140px] pb-16 lg:pb-[100px] gap-8 lg:gap-4`}>
          <div className="max-w-[668px] z-10 text-center lg:text-left">
            ...
            <button
              onClick={connectWallet}
              className="inline-flex items-center justify-center gap-2 px-5 py-2 bg-[#0f766e] rounded-3xl hover:bg-[#0f766e]/90 transition-colors"
              data-testid="button-launch-app-hero"
            >
              <Wallet className="w-5 h-5 text-white" />
              <span className="font-['Inter',sans-serif] font-normal text-white text-[18px] leading-[28px]">
                {walletAddress ? "Enter Dashboard" : "Connect Wallet"}
              </span>
            </button>
          </div>
